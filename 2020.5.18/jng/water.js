...
let pika = {
  ...
  run: function() {
    if (this.isLiving()) {
      if ( !this.isTired() ) {
        view.displayPikaSay(' 杰尼龟正在玩耍! ');
        this.food -= 10;
        this.water = this.water - 10;
        this.clear = this.clear + 10;
        let imageS1 = document.getElementById('imageSwitch');
        if (imageS1.getAttribute("src") == "../image1/water.jpg") { 
          imageS1.setAttribute("src", "../image1/waterrun.jpg");
         } else { 
           imageS1.setAttribute("src", "../image1/water.jpg");
          }
      } else {
        view.displayPikaSay('杰尼龟玩累了。');
        let imageS1 = document.getElementById('imageSwitch');
        if (imageS1.getAttribute("src") == "../image1/water.jpg") { 
          imageS1.setAttribute("src", "../image1/waterpant.jpg");
         } else { 
           imageS1.setAttribute("src", "../image1/water.jpg");
          }
      }
  ...
  baths: function () {
    if (this.isLiving()) {
      this.clear = 0;
      view.displayPikaSay('杰尼龟洗了一个干净的澡！');
    };
    let imageS1 = document.getElementById('imageSwitch');
    if (imageS1.getAttribute("src") == "../image1/water.jpg") { 
      imageS1.setAttribute("src", "../image1/waterbath.jpg");
     } else { 
       imageS1.setAttribute("src", "../image1/water.jpg");
      };  
  },
  ...
  eat: function () {
    if (this.isLiving()) {
      this.water = 100;
      this.food = 100;
      view.displayPikaSay('杰尼龟打了一个饱嗝~');
    }
    let imageS1 = document.getElementById('imageSwitch');
    if (imageS1.getAttribute("src") == "../image1/water.jpg") { 
      imageS1.setAttribute("src", "../image1/watereat.jpg");
     } else { 
       imageS1.setAttribute("src", "../image1/water.jpg");
      }
  },
  ...
  dead: function () {
    ...
    let imageS1 = document.getElementById('imageSwitch');
    if (imageS1.getAttribute("src") == "../image1/water.jpg") { 
      imageS1.setAttribute("src", "../image1/water黑白照.jpg");
     }
  },
  ...
  resurrect: function () {
    if (!this.isLive) {
      ...
      let imageS1 = document.getElementById('imageSwitch');
      if (imageS1.getAttribute("src") == "../image1/water.jpg") { 
        imageS1.setAttribute("src", "../image1/waterT.png");
      } else { 
        imageS1.setAttribute("src", "../image1/water.jpg");
      };
  ...
  risk: function(){
    if(this.health > 0){
      location.href='../water/pikaqRisk.html';
    };
  },
